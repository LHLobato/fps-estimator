    ...
    <div className="w-full">
      ...
      <div className="mb-8">
        ...
        <p className="text-on-surface-variant font-body-lg max-w-2xl">
          Compare two hardware configurations side-by-side and see performance
          differences across multiple games.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-gutter mb-8">
        ...
        <GlassPanel className="p-8 rounded-lg relative overflow-hidden border-l-4 border-l-primary-fixed-dim">
          ...
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-white/5">
            ...
            <h3 className="font-label-caps text-sm text-white tracking-[0.2em]">
              SETUP_01
            </h3>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <p className="font-label-caps text-[10px] text-primary-fixed-dim mb-2">
                CPU
              </p>
        ...
        <GlassPanel className="p-8 rounded-lg relative overflow-hidden border-l-4 border-l-secondary">
          ...
          <div className="space-y-4">
            ...
            <div>
              <p className="font-label-caps text-[10px] text-secondary mb-2">
                CPU
              </p>
              <div className="flex flex-wrap gap-2">
      ...
      <GlassPanel className="p-8 rounded-lg mb-8">
        ...
        <div className="grid grid-cols-2 xl:grid-cols-4 gap-unit-6">
          {metrics.map((metric, idx) => (
            <div
              key={idx}
              className="bg-surface-container-low p-6 rounded border border-white/5"
            >
              <p className="font-label-caps text-[10px] text-on-surface-variant mb-4">
                {metric.label}
              </p>
              <div className="space-y-3">
                <div>
                  ...
                  <p
                    className={`font-data-display text-3xl ${getAdvantageColor(metric.advantage)}`}
                  >
                    {metric.setup1}
                  </p>
      ...
      <GlassPanel className="p-8 rounded-lg">
          ...
          <table className="w-full">
            ...
            <tbody>
              {games.map((game, idx) => (
                ...
                >
                  <td className="py-4 px-4 text-white font-body-md">
                    {game.name}
                  </td>
                  <td className="text-center py-4 px-4">
                    <span className="font-data-display text-2xl text-primary-fixed-dim">
                      {game.setup1}
                    </span>
                  ...
                  <td className="text-center py-4 px-4">
                    <span className="font-data-display text-2xl text-secondary">
                      {game.setup2}
                    </span>
                    <p className="font-label-caps text-[9px] text-on-surface-variant">
                      FPS
                  ...
                  <td className="text-right py-4 px-4">
                    <span
                      className={`font-label-caps text-[10px] ${getAdvantageColor("setup1")}`}
                    >
                      {getDifference(game)}
                    </span>
                  </td>
        ...
        <div className="mt-8 pt-8 border-t border-white/10 grid grid-cols-2 gap-unit-6">
          <div className="bg-surface-container-low p-6 rounded border border-white/5">
            ...
            <p className="font-data-display text-4xl text-primary-fixed-dim">
              127.6
            </p>
            <p className="font-label-caps text-[10px] text-on-surface-variant mt-2">
              FPS ACROSS ALL GAMES
            </p>
          </div>
          <div className="bg-surface-container-low p-6 rounded border border-white/5">
            <p className="font-label-caps text-[10px] text-on-surface-variant mb-4">
